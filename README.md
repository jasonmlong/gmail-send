...
You can use it from Claude Desktop, Claude Code, another MCP client, the CLI, or a Node application. The renderer follows the HTML and plain-text shapes observed in Gmail's web compose.
