...
- The Apps Script raw-draft endpoint in this checkout still accepted Bcc, and its update action could overwrite a draft it did not create. Those paths now refuse Bcc and unowned draft updates. The remote OpenClaw checkout already had these controls; they were preserved when formatting was added there.
